...
mixin _$FossColorsTailorMixin on ThemeExtension<FossColors> {
  ...
  @override
  FossColors lerp(covariant ThemeExtension<FossColors>? other, double t) {
    if (other is! FossColors) return this as FossColors;
    return FossColors(
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      const DeepCollectionEquality().hash(cardForeground),
      const DeepCollectionEquality().hash(popover),
      const DeepCollectionEquality().hash(popoverForeground),
      ...
      const DeepCollectionEquality().hash(successForeground),
      const DeepCollectionEquality().hash(warning),
      const DeepCollectionEquality().hash(warningForeground),
